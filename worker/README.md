...
Included Smart Import parsing for all VaultCap users — no API key setup required in the app.
...
- VaultCap ships with bundled credentials in `js/config/llm-bundled.js`
