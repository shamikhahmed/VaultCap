...
const ASSET_TYPES_MAP = {
  property:        { label:'Property',        icon:'🏠', color:'#ff9f0a' },
  vehicle:         { label:'Vehicle',         icon:'🚗', color:'#5b8dee' },
  electronics:     { label:'Electronics',     icon:'💻', color:'#30d158' },
  precious_metals: { label:'Precious Metals', icon:'🥇', color:'#c9a84c' },
  precious:        { label:'Precious Metals', icon:'🥇', color:'#c9a84c' },
  watch:           { label:'Watch',           icon:'⌚', color:'#9e9e9e' },
  jewelry:         { label:'Jewellery',       icon:'💍', color:'#e91e8c' },
  subscription:    { label:'Subscription',   icon:'🔄', color:'#636366' },
  insurance:       { label:'Insurance',      icon:'🛡️', color:'#636366' },
  business:        { label:'Business',       icon:'🏢', color:'#af52de' },
  loan:            { label:'Loan Asset',     icon:'💰', color:'#ff6b35' },
...
const Assets = {
  ...
  form(a = {}) {
    ...
    <div class="fr"><div class="fg"><label class="fl">Purchase Price</label><input class="inp" id="af-pp" value="${a.purchasePrice||''}" type="number" placeholder="0"></div><div class="fg"><label class="fl">Current Value</label><input class="inp" id="af-cv" value="${a.currentValue||''}" type="number" placeholder="0"></div></div>
    <div class="fr"><div class="fg"><label class="fl">Currency</label><select class="inp" id="af-cur">${U.currencies()}</select></div><div class="fg"><label class="fl">Purchase Date</label><input class="inp" id="af-date" value="${a.purchaseDate||''}" type="date"></div></div>
