...
const VaultRelations = {
  ...
  _ISSUER_ALIASES: {
    ...
    khushhali: 'khushhali microfinance bank',
    nrsp: 'nrsp microfinance bank',
    'u bank': 'u microfinance bank',
    ztbl: 'zarai taraqiati bank',
    samba: 'samba bank',
    skipton: 'skipton building society',
    shawbrook: 'shawbrook bank',
    ...
    'al maryah': 'al maryah community bank',
    yap: 'yap',
    zand: 'zand bank',
    nomo: 'nomo bank',
    investec: 'investec bank uk',
    handelsbanken: 'handelsbanken uk',
  },
