...
const Migrate = {
  run() {
    ...
    if(window.__VC_DEBUG&&typeof window.__VC_log==='function')window.__VC_log(`VaultCap: migrating schema v${sv} → v${SCHEMA_VERSION}`);
    ...
    if (sv < 10) {
      ...
      if(window.__VC_DEBUG&&typeof window.__VC_log==='function')window.__VC_log('[VaultCap] Migrated schema v9 → v10: vehicles/gadgets/gold consolidated into assets');
    }
    if (sv < 11) {
      try {
        ...
        if(window.__VC_DEBUG&&typeof window.__VC_log==='function')window.__VC_log('[VaultCap] Migrated family data v10 → v11');
      } catch(e) {}
    ...
    if (sv < 12) {
      ...
      if(window.__VC_DEBUG&&typeof window.__VC_log==='function')window.__VC_log('[VaultCap] Migrated schema v11 → v12: owners array backfilled');
    }
    if (sv < 13) {
      ...
      if(window.__VC_DEBUG&&typeof window.__VC_log==='function')window.__VC_log('[VaultCap] Migrated schema v12 → v13: family members flattened into S.familyMembers');
    }
    if (stored.cards) {
  ...
  _runFamilyV13(store) {
    ...
    if(window.__VC_DEBUG&&typeof window.__VC_log==='function')window.__VC_log('[VaultCap] Live migration: family → familyMembers (' + newMembers.length + ' members)');
  }
};
