  ...
  show() {
    const body = `
      <div style="display:flex;flex-direction:column;gap:14px;font-size:13px;line-height:1.6;color:var(--text2)">
        ...
        <div>
          <div class="vc-ix-39">PIN (daily unlock)</div>
          <ul class="vc-ix-40">
            <li>PIN unlocks a random vault DEK (wrapped). PIN alone is not the data key after first unlock migrate.</li>
        ...
        <div>
          <div class="vc-ix-39">Master recovery key</div>
          <ul class="vc-ix-40">
        ...
        <div>
          <div class="vc-ix-39">Backup key + .vos file</div>
          <ul class="vc-ix-40">
        ...
        <div>
          <div class="vc-ix-39">Decoy PIN</div>
          <ul class="vc-ix-40">
        ...
        <div>
          <div class="vc-ix-39">What we do not do</div>
          <ul class="vc-ix-40">
        ...
        <div>
          <div class="vc-ix-39">When online</div>
          <ul class="vc-ix-40">
