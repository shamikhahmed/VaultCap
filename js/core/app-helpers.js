...
var InstallPrompt = (function () {
  ...
  function _showBanner() {
    ...
    b.innerHTML = '<div style="font-size:28px;flex-shrink:0" aria-hidden="true">🔐</div><div style="flex:1"><div style="font-size:13px;font-weight:700;color:var(--text)">Install VaultCap</div><div style="font-size:12px;color:var(--text2);margin-top:2px">Works offline. No tracking.</div></div><button type="button" style="padding:7px 14px;background:var(--accent,#5b8dee);color:#fff;border:none;border-radius:10px;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap" aria-label="Install app" onclick="InstallPrompt.install()">Install</button><button type="button" style="padding:7px 10px;background:none;border:none;color:var(--text2);font-size:18px;cursor:pointer;line-height:1" aria-label="Dismiss install prompt" onclick="InstallPrompt.dismiss()">✕</button>';
